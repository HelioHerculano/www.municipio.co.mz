    ...
    (r.prototype.init = function () {
          ...
          datasets: [
            {
              ...
              pointBorderColor: "#388A1C",
              pointBackgroundColor: "#fff",
              pointBorderWidth: 1,
              pointHoverRadius: 5,
              pointHoverBackgroundColor: "#388A1C",
      ...
      this.respChart(d("#doughnut"), "Doughnut", {
        ...
        datasets: [
          {
            data: [300, 210],
            backgroundColor: ["#388A1C", "#ebeff2"],
            hoverBackgroundColor: ["#388A1C", "#ebeff2"],
      ...
      this.respChart(d("#polarArea"), "PolarArea", {
        datasets: [
          {
            data: [11, 16, 7, 18],
            backgroundColor: ["#ff715b", "#45cb85", "#eeb902", "#388A1C"],
            label: "My dataset",
            hoverBorderColor: "#fff",
          },
        ],
